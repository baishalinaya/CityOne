...
const AboutUs = () => {
  ...
  return (
    <div className="Main-intro">
      ...
      <p class="welcome">
        WELCOME TO <b>CityOne</b> your premier destination for all things
        city-related!
      </p>
      ...
      <div class="the-team">
        <div>
            <p>We're a team of students united by our passion for technology and innovation. Individually, we're accomplished in our own right, with each member bringing a unique combination of skills, experience, and perspectives to the table. Whether it's web development, UX design, backend development, data analysis, or project management, we're all dedicated to excellence in our respective areas. But what makes us truly special is our ability to come together as a cohesive unit, leveraging our collective strengths to achieve far more than we could alone. We're a team of equals, driven by a shared enthusiasm for learning, growth, and making a meaningful impact.</p></div>
